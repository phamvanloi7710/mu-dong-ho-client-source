...
void OpenPLImageData() {
	LoadBitmap("PL\\Interface\\main_back.tga", IMAGE_MAIN_BACKGROUND, GL_LINEAR);
	LoadBitmap("PL\\Interface\\main_border.tga", IMAGE_MAIN_BORDER, GL_LINEAR);
	//LoadBitmap("PL\\Interface\\main_close.tga", PL_INTERFACE::BUTTON_CLOSE_MAIN_29_29, GL_LINEAR);
	LoadBitmap("Interface\\mini_map_ui_cancel.tga", PL_INTERFACE::BUTTON_CLOSE_MAIN_29_29, GL_LINEAR);
	LoadBitmap("Interface\\InGameShop\\Ingame_Bt01.tga", PL_INTERFACE::BUTTON_NORMAL_73_27, GL_LINEAR);
	LoadBitmap("Interface\\newui_btn_empty.tga", PL_INTERFACE::BUTTON_NORMAL_108_29, GL_LINEAR);
}
