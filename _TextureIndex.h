...
enum
{
	...
	BITMAP_START_SPK_BIT,
	BITMAP_START_SPK_BIT_END = BITMAP_START_SPK_BIT + 10,
	BITMAP_START_SPK, // +120 / 300
	
	BITMAP_START_SPK_FORM = BITMAP_START_SPK + 300,
