			...
			else
			{
...

				{
					...
					if (fAngleDistance <= (fRotateSpeed))
						...
						m_fTourCameraAngle += AdvanceByDelta(1.0) * (fRotateSpeed * fRotDir);
				...
				if (IsTourPaused())
				{
					...
					{
						m_CurrentCameraPos[0] += AdvanceByDelta(1.0) * (fRvsDirVector[0] * originfCameraMoveAccel);
						m_CurrentCameraPos[1] += AdvanceByDelta(1.0) * (fRvsDirVector[1] * originfCameraMoveAccel);
						m_vTourCameraPos[0] += AdvanceByDelta(1.0) * (fTourDirVector[0] * originfCameraMoveAccel);
						m_vTourCameraPos[1] += AdvanceByDelta(1.0) * (fTourDirVector[1] * originfCameraMoveAccel);
					}
				}
				else
				{
					m_CurrentCameraPos[0] += AdvanceByDelta(1.0) * (fDirVector[0] * targetfCameraMoveAccel);
					m_CurrentCameraPos[1] += AdvanceByDelta(1.0) * (fDirVector[1] * targetfCameraMoveAccel);
					m_vTourCameraPos[0] += AdvanceByDelta(1.0) * (fTourDirVector[0] * targetfCameraMoveAccel);
					m_vTourCameraPos[1] += AdvanceByDelta(1.0) * (fTourDirVector[1] * targetfCameraMoveAccel);
				}
