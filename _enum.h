...
namespace SEASON3B
{
	enum INTERFACE_LIST
	{
		...
		INTERFACE_CUSTOM,
		INTERFACE_VIEW_CHARINFO,	
		PCINTERFACE_CUSTOM,

		#if USING_RECHARGE_MONEY
			INTERFACE_RECHARGE_MONEY_SYSTEM,
			INTERFACE_RECHARGE_MONEY_DETAIL_MAIN,
			INTERFACE_RECHARGE_MONEY_CANCEL_PAYMENT_MAIN,
		#endif // USING_RECHARGE_MONEY

		#if USING_RESET_WITH_GUI
			INTERFACE_RESET_SYSTEM,
		#endif // USING_RESET_WITH_GUI
		INTERFACE_NOTIFICATION_MAIN,
	};
}

namespace PL_INTERFACE {
	enum ButtonList {
		BUTTON_CLOSE_MAIN_29_29,
		BUTTON_NORMAL_73_27,
		BUTTON_NORMAL_108_29,
	};
}
