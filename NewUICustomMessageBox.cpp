...
CALLBACK_RESULT SEASON3B::CSystemMenuMsgBox::GameOverBtnDown(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam)
{
	...
	#if USING_RECONNECT_ACCOUNT
		if (g_PLReconnect->s_Data.ReconnectStatus == g_PLReconnect->RECONNECT_STATUS_RECONNECT)
		{
			g_PLReconnect->s_Data.ReconnectStatus = g_PLReconnect->RECONNECT_STATUS_DISCONNECT;
		}
	#endif // USING_RECONNECT_ACCOUNT
