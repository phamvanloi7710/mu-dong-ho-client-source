...
CNewUIPhongDraw::CNewUIPhongDraw()
{
}
...
bool CNewUIPhongDraw::DrawCustomWindows(float* StartX, float* StartY, float CuaSoW, float CuaSoH, int eNumWindow, LPCSTR Text, ...)
{
...
void CNewUIPhongDraw::DrawInfoBox(float PosX, float PosY, float Width, float Height, DWORD bkcolor, int Arg6, int Arg7)
{
...
bool CNewUIPhongDraw::Create(CNewUIManager* pNewUIMng, int x, int y)
{
	if (NULL == pNewUIMng)
		return false;

	m_pNewUIMng = pNewUIMng;
	m_pNewUIMng->AddUIObj(SEASON3B::PCINTERFACE_CUSTOM, this);
...
void CNewUIPhongDraw::SetPos(int x, int y)
{
	m_Pos.x = x;
	m_Pos.y = y;
}

void CNewUIPhongDraw::Release()
{
	UnloadImages();
...
bool CNewUIPhongDraw::UpdateMouseEvent()
{
	return true;
}

bool CNewUIPhongDraw::UpdateKeyEvent()
{
	return true;
}

bool CNewUIPhongDraw::Update()
{
	return true;
}

bool CNewUIPhongDraw::Render() //Work()
{
	return true;
}

float CNewUIPhongDraw::GetLayerDepth()
{
	return 9.3f;
}
void CNewUIPhongDraw::LoadImages()
{
...
void CNewUIPhongDraw::UnloadImages()
{
