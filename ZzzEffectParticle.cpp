		...
		if (o->Live)
		{
			...
			case BITMAP_EFFECT:
				if (o->LifeTime >= 10)
				{
					if (o->SubType == 2)
					{
						o->Light[0] /= ReduceWithDelta(1.03f);
						o->Light[1] /= ReduceWithDelta(1.03f);
						o->Light[2] /= ReduceWithDelta(1.03f);
					}
					else
					{
						o->Light[0] *= ReduceWithDelta(1.16f);
						o->Light[1] *= ReduceWithDelta(1.16f);
						o->Light[2] *= ReduceWithDelta(1.16f);
					}
				}
				else
				{
			...
			case BITMAP_FLOWER01 + 2:
				if (o->Frame == 0)
				{
					if (o->SubType == 0)
					{
						o->Velocity[0] += ((float)(rand() % 32 - 16) * ReduceWithDelta(0.1f));
						o->Velocity[1] += ((float)(rand() % 32 - 16) * ReduceWithDelta(0.1f));
						o->Velocity[2] += ((float)(rand() % 32 - 16) * ReduceWithDelta(0.1f));
					}
					else if (o->SubType == 1)
					{
						o->Velocity[0] += ((float)(rand() % 8 - 4) * ReduceWithDelta(0.05f));
						o->Velocity[1] += ((float)(rand() % 8 - 4) * ReduceWithDelta(0.05f));
						o->Velocity[2] -= ((float)(rand() % 8) * ReduceWithDelta(0.05f));
					}
				...
				o->Rotation += AdvanceByDelta(rand() % 16);
				break;
			case BITMAP_FLARE_BLUE:
				if (o->SubType == 0)
				{
					...
					o->Velocity[2] += AdvanceByDelta(0.4f);
					o->Velocity[2] = min(8.f, o->Velocity[2]);

					if (o->LifeTime < 5)
					{
						o->Light[0] /= ReduceWithDelta(1.2f);
						o->Light[1] /= ReduceWithDelta(1.2f);
						o->Light[2] /= ReduceWithDelta(1.2f);
					}
				}
				else if (o->SubType == 1)
				{
					o->Light[0] /= ReduceWithDelta(1.1f);
					o->Light[1] /= ReduceWithDelta(1.1f);
					o->Light[2] /= ReduceWithDelta(1.1f);
					o->Scale += AdvanceByDelta(1.5f);
				}
				break;
			case BITMAP_FLARE + 1:
				if (o->SubType == 0)
				{
					...
					o->Scale -= AdvanceByDelta(0.0008f);
				}
				break;
			case BITMAP_BLUE_BLUR:
				switch (o->SubType)
				...
				case 0:
					...
					if (o->SubType == 1)
					{
						o->Scale += AdvanceByDelta(0.19f);
						o->Position[2] += AdvanceByDelta(5.00f);
					}
					else
						o->Scale += AdvanceByDelta(0.05f);
			...
			case BITMAP_LIGHT + 2:
				if (o->SubType == 3)
				{
					o->Gravity += AdvanceByDelta(0.2f);
					//o->Position[2] += AdvanceByDelta(o->Gravity);
					o->Scale -= AdvanceByDelta(0.03f);
				...
				{
					o->TurningForce[2] -= AdvanceByDelta(o->Gravity);

					o->Position[0] += AdvanceByDelta(o->TurningForce[0]);
					o->Position[1] += AdvanceByDelta(o->TurningForce[1]);
					o->Position[2] += AdvanceByDelta(o->TurningForce[2]);

					o->Angle[0] += (0.5f * o->LifeTime._runvalue);
					o->Angle[1] += (0.5f * o->LifeTime._runvalue);
					o->Scale += AdvanceByDelta(0.04f);
					if (o->LifeTime < 10)
					{
						o->Alpha -= AdvanceByDelta(0.1f);
					}
					if (o->LifeTime < 20)
					{
						o->TurningForce[0] *= ReduceWithDelta(0.6f);
						o->TurningForce[1] *= ReduceWithDelta(0.6f);
					}
					...
					VectorCopy(o->Target->Position, o->StartPosition);
					VectorAdd(o->Position, o->StartPosition, o->Position);
					o->Velocity[0] += AdvanceByDelta(0.05f);
					o->Velocity[1] += AdvanceByDelta(0.05f);

					o->Rotation += AdvanceByDelta(1.0f);
				}
				else if (o->SubType == 6)
				{
					o->TurningForce[2] -= AdvanceByDelta(o->Gravity);
					...
					o->Angle[0] += AdvanceByDelta(0.5f * o->LifeTime._runvalue);
					o->Angle[1] += AdvanceByDelta(0.5f * o->LifeTime._runvalue);
					o->Scale += AdvanceByDelta(0.04f);
					if (o->LifeTime < 10)
					{
						o->Alpha -= AdvanceByDelta(0.1f);
					...
					o->Rotation += AdvanceByDelta(2.0f);
				}
				else if (o->SubType == 7)
				{
					o->TurningForce[2] -= AdvanceByDelta(o->Gravity);
					...
					o->Light[0] += AdvanceByDelta(Luminosity);
					o->Light[1] += AdvanceByDelta(Luminosity);
					o->Light[2] += AdvanceByDelta(Luminosity);
				}
				else
				{
					Luminosity = (float)(o->LifeTime) / 8.f * 0.02f;
			...
			case BITMAP_MAGIC + 1:
			{
				o->Light[0] *= ReduceWithDelta(0.9f);
				o->Light[1] *= ReduceWithDelta(0.9f);
				o->Light[2] *= ReduceWithDelta(0.9f);
				o->Scale += AdvanceByDelta(0.1f);
			}
			break;
			case BITMAP_BUBBLE:
				...
				case 0:
					o->Frame++;
					o->Position[0] += AdvanceByDelta((float)(rand() % 20 - 10) * 2.5f * o->Scale);
					o->Position[1] += AdvanceByDelta((float)(rand() % 20 - 10) * 2.5f * o->Scale);
					o->Position[2] += AdvanceByDelta((float)(rand() % 20 + 10) * 2.5f * o->Scale);
					break;
				case 1:
					o->Frame++;
					o->Position[0] += AdvanceByDelta((float)(rand() % 30 - 15) * 1.f * o->Scale);
					o->Position[1] += AdvanceByDelta((float)(rand() % 30 - 15) * 1.f * o->Scale);
					o->Position[2] += AdvanceByDelta((float)(rand() % 20 + 10) * 0.3f * o->Scale);
					o->Scale += AdvanceByDelta(0.002f);
					break;
				case 2:
					o->Position[0];
					o->Position[1];
					o->Position[2] += AdvanceByDelta((float)(rand() % 20 + 10) * 0.3f);
					o->Scale += AdvanceByDelta(0.005f);
					break;

				case 3:
					o->Frame++;
					o->Position[0] += AdvanceByDelta((float)(rand() % 20 - 10) * 2.5f * o->Gravity);
					o->Position[1] += AdvanceByDelta((float)(rand() % 20 - 10) * 2.5f * o->Gravity);
					o->Position[2] += AdvanceByDelta((float)(rand() % 20 + 10) * 2.5f * o->Gravity);
					break;
				case 4:
					o->Position[0];
					o->Position[1];
			...
			case BITMAP_LIGHTNING + 1:
				...
				if (o->SubType == 2)
				{
					...
					o->Position[2] += AdvanceByDelta(80.f);
				}
				break;
			case BITMAP_LIGHTNING:
				o->Frame = rand() % 4;
			...
			case BITMAP_FIRE_HIK2_MONO:
				if (o->SubType == 0)
				{
					o->Scale -= AdvanceByDelta((rand() % 20 + 10) * 0.001f);
					Luminosity -= AdvanceByDelta(0.05f);
					o->Position[2] += AdvanceByDelta((o->Gravity * 10.0));
				}
				else if (o->SubType == 1)
				{
					o->Scale -= AdvanceByDelta((rand() % 5 + 15) * 0.0016f);
					o->Position[2] += AdvanceByDelta((o->Gravity * 10.0));
				...
				{
					o->Scale -= AdvanceByDelta((rand() % 20 + 10) * 0.004f);
					Luminosity -= AdvanceByDelta(0.05f);
					o->Position[2] += AdvanceByDelta((o->Gravity * 25.f));
				}
				else if (o->SubType == 3)
				{
					o->Scale -= AdvanceByDelta(0.03f);
				...
				else if (o->SubType == 4 || o->SubType == 9)
				{
					if (o->LifeTime < 10)
					{
						o->Alpha -= AdvanceByDelta(0.2f);
					}
					else if (o->Alpha < 1.0f)
					{
						o->Alpha += (rand() % 2 + 2) * (0.1f) * AdvanceByDelta(1.0);
					}
					else
					{
						o->Alpha = 1.0f;
					...
					if (o->Scale > 0)
					{
						o->Scale -= ((rand() % 3 + 6) * 0.01f) * AdvanceByDelta(1.0);
					}
					else
					{
						o->Live = false;
					...
					o->Position[2] += AdvanceByDelta(o->Gravity);
					o->Rotation += AdvanceByDelta(3.0f);

					if (o->SubType == 9)
					{
						o->Rotation = 0.0f;
						o->Position[2] += AdvanceByDelta(o->Gravity * 1.2f);
					}
				}
				else if (o->SubType == 5)
				{
					...
					if (o->Scale > 0)
					{
						o->Scale -= ((rand() % 2 + 5) * 0.01f) * AdvanceByDelta(1.0);
					}
					else
					{
						o->Live = false;
				...
				else if (o->SubType == 6)
				{
					...
					o->Position[0] += AdvanceByDelta(o->Velocity[0]);
					o->Position[1] += AdvanceByDelta(o->Velocity[1]);
					o->Position[2] += AdvanceByDelta(o->Gravity);
					o->Rotation += AdvanceByDelta(3.0f);
				}
				else if (o->SubType == 7)
				{
					...
					if (o->Scale > 0)
					{
						o->Scale -= (rand() % 3 + 3) * 0.01f * AdvanceByDelta(1.0);
					}
					else
					{
						o->Live = false;
				...
				else if (o->SubType == 8)
				{
					...
					o->Scale += AdvanceByDelta((rand() % 3 + 8) * 0.01f);
					...
					o->Rotation += AdvanceByDelta(5.0f);
				}
				break;
			case BITMAP_LEAF_TOTEMGOLEM:
			{
				o->Velocity[2] += AdvanceByDelta(o->Gravity);
				...
				if (o->Position[2] <= Height)
				{
					...
					o->Position[2] = Height;
					o->Alpha -= AdvanceByDelta(0.05f);
					Vector(o->Alpha, o->Alpha, o->Alpha, o->Light);
				}
				else
				{
					o->Scale += AdvanceByDelta(0.01f);
				}
			}
			break;
			case BITMAP_FIRE:
			...
			case BITMAP_FIRE + 3:
				...
				case 0:
				{
					o->Gravity += (AdvanceByDelta(0.004f));
					Luminosity = (float)(o->LifeTime) / 24.f;
					o->Scale -= (AdvanceByDelta(0.04f));
					o->Frame = (23 - o->LifeTime._runvalue) / 6;
				...
				case 9:
				{
					...
					o->Gravity += (AdvanceByDelta(((rand() % 60) + 60) / 100));
				...
				case 12:
				{
					o->Gravity += (AdvanceByDelta(0.004f));
					Luminosity = (float)(o->LifeTime) / 24.f;
					o->Rotation += (AdvanceByDelta((float)(rand() % 10 + 10.f)));
					o->Scale -= (AdvanceByDelta(0.04f));
				...
				case 16:
				{
					...
					o->Light[0] /= (ReduceWithDelta(1.7f));
					o->Light[1] /= (ReduceWithDelta(1.7f));
					o->Light[2] /= (ReduceWithDelta(1.7f));
					o->Scale *= (ReduceWithDelta(1.1f));
				}break;
				case 18:
				{
					o->Gravity += (AdvanceByDelta(0.004f));
					Luminosity = (float)(o->LifeTime) / 24.f;
					o->Scale += (o->Gravity);
					VectorScale(o->Velocity, ReduceWithDelta(0.98f), o->Velocity);
					o->Frame = (23 - o->LifeTime._runvalue) / 6;
					o->Position[2] += (o->Gravity * 10.f);
					VectorScale(o->Light, ReduceWithDelta(0.95f), o->Light);
				}
				break;
				default:
				{
			...
			case BITMAP_FIRE + 1:
				if (o->SubType == 1)
				{
					VectorScale(o->Velocity, ReduceWithDelta(1.05f), o->Velocity);
					o->Position[2] += (AdvanceByDelta(o->Gravity * 20.f));
				...
				{
					o->Gravity += (AdvanceByDelta(0.02f));
					o->Scale += AdvanceByDelta(o->Gravity);
					VectorScale(o->Velocity, ReduceWithDelta(1.05f), o->Velocity);
					o->Position[2] += AdvanceByDelta((o->Gravity * 20.f));
					Luminosity = (float)(o->LifeTime) * 0.2f;
					Vector(Luminosity, Luminosity, Luminosity, o->Light);
				...
				else if (o->SubType == 5)
				{
					...
					o->Position[2] += (AdvanceByDelta(o->Gravity));
					o->Rotation += (AdvanceByDelta(1));
					//o->Scale += (0.003f);
				}
				else if (o->SubType == 6)
				{
					o->Position[2] += (AdvanceByDelta(o->Gravity));
					o->Rotation += (AdvanceByDelta(4));
				}
				else if (o->SubType == 7)
				{
					VectorScale(o->Velocity, ReduceWithDelta(1.05f), o->Velocity);
				...
				{
					o->Scale += (AdvanceByDelta(0.13f));
					o->Rotation += (AdvanceByDelta(o->Gravity));
					o->Light[0] /= (ReduceWithDelta(1.13f));
					o->Light[1] /= (ReduceWithDelta(1.13f));
					o->Light[2] /= (ReduceWithDelta(1.13f));
				}
				else if (o->SubType == 0)
				{
					o->Gravity += AdvanceByDelta(0.02f);
					o->Scale += AdvanceByDelta(o->Gravity);
					o->Velocity[0] *= (ReduceWithDelta(1.05));
					o->Velocity[1] *= (ReduceWithDelta(1.05));
					o->Velocity[2] *= (ReduceWithDelta(1.05));
			...
			case BITMAP_FLAME:
				...
				case 1:
					if (o->LifeTime == 10)
					{
						o->Velocity[1] += AdvanceByDelta(32 * 0.2f);
						o->Scale -= AdvanceByDelta(0.15f);
					}
					o->Rotation = (float)(rand() % 360);
					o->Light[0] -= AdvanceByDelta(0.05f);
					o->Light[1] -= AdvanceByDelta(0.05f);
					o->Light[2] -= AdvanceByDelta(0.05f);
					break;
				case 5:
					if (o->LifeTime == 10)
					{
						o->Velocity[1] += AdvanceByDelta(32 * 0.2f);
						o->Scale *= ReduceWithDelta(0.8f);
					}
					o->Rotation = (float)(rand() % 360);
					o->Light[0] -= AdvanceByDelta(0.05f);
					o->Light[1] -= AdvanceByDelta(0.05f);
				...
				case 8:
				{
					...
					o->Position[2] += AdvanceByDelta(o->Gravity / 2.f);
					o->Scale -= AdvanceByDelta(o->Gravity / 95.f);
					if (o->Scale <= 0.0f)
						o->Live = false;

					o->Light[0] /= ReduceWithDelta(1.007f);
					o->Light[1] /= ReduceWithDelta(1.007f);
					o->Light[2] /= ReduceWithDelta(1.007f);
				}
				break;
				case 7:
				{
				...
				{
					if (o->StartPosition[0] < o->Position[0])
						o->Rotation += AdvanceByDelta(0.5f);
					else
						o->Rotation -= AdvanceByDelta(0.5f);

					o->Position[2] += AdvanceByDelta(o->Gravity * 1.2f);
					o->Scale -= AdvanceByDelta(o->Gravity / 98.f);
					if (o->Scale <= 0.0f)
						o->Live = false;

					o->Light[0] /= ReduceWithDelta(1.008f);
					o->Light[1] /= ReduceWithDelta(1.008f);
					o->Light[2] /= ReduceWithDelta(1.008f);
				}
				break;
				case 10:
					VectorAdd(o->Position, o->Velocity, o->Position);
					o->Velocity[0] *= ReduceWithDelta(0.95f);
					o->Velocity[1] *= ReduceWithDelta(0.95f);
					o->Light[0] = (float)(o->LifeTime) / 10.f;
					o->Light[1] = o->Light[0];
					o->Light[2] = o->Light[0];
					o->Velocity[2] += AdvanceByDelta(0.3f);
					o->Scale += AdvanceByDelta(0.07f);
					break;
				case 11:
					o->Light[0] /= ReduceWithDelta(1.008f);
					o->Light[1] /= ReduceWithDelta(1.008f);
			...
			case BITMAP_ENERGY:
			{
				...
				{
					o->Light[0] -= AdvanceByDelta(0.01f);
					o->Light[1] -= AdvanceByDelta(0.01f);
					o->Light[2] -= AdvanceByDelta(0.01f);
				}
				else if (o->SubType == 3 || o->SubType == 4 || o->SubType == 5)
				{
					BMD* pModel = gmClientModels->GetModel(o->Target->Type);
					if (pModel)
					{
						...
						o->Light[0] /= ReduceWithDelta(1.01f);
						o->Light[1] /= ReduceWithDelta(1.01f);
						o->Light[2] /= ReduceWithDelta(1.01f);
					}
				}
#ifdef PBG_ADD_NEWCHAR_MONK_SKILL
				else if (o->SubType == 7)
				{
					VectorScale(o->Light, ReduceWithDelta(0.97f), o->Light);
				}
#endif //PBG_ADD_NEWCHAR_MONK_SKILL
			}
			break;
			...
			case BITMAP_FLARE:  //
				...
				else if (o->SubType == 2)
				{
					o->Position[0] = o->StartPosition[0];
					o->Position[1] = o->StartPosition[1];
					o->Position[2] += AdvanceByDelta(o->Gravity * ((60 - o->LifeTime._runvalue) / 10));
					o->Scale -= AdvanceByDelta(0.002f);
				}
				else if (o->SubType == 5)
				{
					...
					o->StartPosition[0] += AdvanceByDelta(2.5f);
				}
				...
				else if (o->SubType == 12)
				{
					...
					o->Position[2] += AdvanceByDelta((o->Gravity + 0.1f));
			...
			case BITMAP_CLUD64:
			{
				if (o->SubType == 0)
				{
					Luminosity = (float)(o->LifeTime) / 10.f;
					Vector(Luminosity, Luminosity, Luminosity, o->Light);
					o->Gravity -= AdvanceByDelta(0.01f);
					o->Position[2] -= (o->Gravity);
					o->Scale -= AdvanceByDelta(0.03f);
					o->Alpha -= AdvanceByDelta(0.05f);
				}
				...
				else if (o->SubType == 6)
				{
					...
					{
						o->Alpha += ((rand() % 2 + 3) * ReduceWithDelta(0.1f));
					}
					else
					{
						o->Alpha = 1.0f;
					...
					if (o->Scale > 0)
					{
						o->Scale -= AdvanceByDelta((rand() % 5 + 55) * 0.001f);
					}
				...
				else if (o->SubType == 7)
				{
					...
					{
						o->Alpha += ((float)(rand() % 20) * ReduceWithDelta(0.005f));
					}

					VectorAdd(o->Position, o->Velocity, o->Position);
					o->Scale += AdvanceByDelta(((float)(rand() % 10) * 0.01f));
				}
				else if (o->SubType == 8)
				{
					if (o->LifeTime < 10)
				...
				{
					o->Scale *= ReduceWithDelta(0.98f + ((float)(rand() % 20 - 10) * 0.002f));

					o->Light[0] *= ReduceWithDelta(0.95f + ((float)(rand() % 20 - 10) * 0.002f));
					o->Light[1] *= ReduceWithDelta(0.95f + ((float)(rand() % 20 - 10) * 0.002f));
					o->Light[2] *= ReduceWithDelta(0.95f + ((float)(rand() % 20 - 10) * 0.002f));
					o->Alpha *= ReduceWithDelta(0.95f + ((float)(rand() % 20 - 10) * 0.002f));
				}
				else if (o->SubType == 10)
				{
					o->Scale -= AdvanceByDelta((rand() % 5 + 15) * 0.0016f);
			...
			case BITMAP_TWINTAIL_WATER:
			{
				...
				{
					o->Scale -= AdvanceByDelta(0.013f);
				}
				else if (o->SubType == 2)
				{
					o->Scale -= AdvanceByDelta(0.026f);
				}

				o->Position[2] += AdvanceByDelta(o->Gravity);
				o->Alpha -= AdvanceByDelta(0.05f);
				o->Light[0] /= ReduceWithDelta(1.02f);
				o->Light[1] /= ReduceWithDelta(1.02f);
				o->Light[2] /= ReduceWithDelta(1.02f);
			}
			break;
			case BITMAP_SMOKE:
				switch (o->SubType)
				...
				case 36:
					if (o->LifeTime < 23)
					{
						o->Gravity += AdvanceByDelta(0.1f * o->Scale);
						o->Position[2] += AdvanceByDelta(o->Gravity);
						o->Position[1] += AdvanceByDelta(o->Gravity);
						o->Scale -= AdvanceByDelta(0.08f);
					}
					else
					{
					...
					o->Rotation += (AdvanceByDelta(0.01f));
					break;
				case 37:
					o->Position[2] -= AdvanceByDelta(o->TurningForce[2] * 0.8f);
					o->Position[1] -= AdvanceByDelta(o->TurningForce[1] * 0.8f);
					o->Scale += AdvanceByDelta(0.08f);
					o->Rotation += AdvanceByDelta(0.01f);
					o->Light[0] /= ReduceWithDelta(1.03f);
					o->Light[1] /= ReduceWithDelta(1.03f);
					...
					break;
				case 38:
					o->Scale += AdvanceByDelta(0.09f);
					o->Light[0] /= ReduceWithDelta(1.04f);
					o->Light[1] /= ReduceWithDelta(1.04f);
					o->Light[2] /= ReduceWithDelta(1.04f);
					break;
				case 33:
					Luminosity = ((float)o->LifeTime) / 8.f;
					Vector(Luminosity * 0.4f, Luminosity * 0.4f, Luminosity, o->Light);
					VectorScale(o->Velocity, ReduceWithDelta(0.001f), o->Velocity);
					o->Scale += AdvanceByDelta(0.01f * 2);
					o->Position[2] += AdvanceByDelta(o->Scale);
					break;
				case 32:
					Luminosity = (float)(o->LifeTime) / 8.f;
					Vector(Luminosity * 0.8f, Luminosity * 0.8f, Luminosity, o->Light);
					VectorScale(o->Velocity, ReduceWithDelta(0.4f), o->Velocity);
					o->Scale += AdvanceByDelta(0.1f);
					break;
				case 23:
					Luminosity = (float)(o->LifeTime) / 8.f;
				...
				case 14:
					...
					VectorScale(o->Velocity, ReduceWithDelta(0.4f), o->Velocity);
					o->Scale += AdvanceByDelta(0.05f);
					o->Position[2] -= AdvanceByDelta(1.f);
					break;
				case 17:
					Luminosity = (float)(o->LifeTime) / 8.f;
				...
				case 15:
					...
					o->Gravity += AdvanceByDelta((rand() % 20) / (500.f));
					o->Position[0] += AdvanceByDelta((rand() % 100 - 20) / (100.f));
					o->Position[1] += AdvanceByDelta((rand() % 100 - 20) / (100.f));
					o->Position[2] += AdvanceByDelta(o->Gravity);
					o->Scale += AdvanceByDelta((rand() % 10) / (1000.f));
					o->Rotation = o->Scale;
					break;
				case 1:
					Luminosity = (float)(o->LifeTime) / 50.f;
				...
				case 2:
					...
					Vector(Luminosity, Luminosity, Luminosity, o->Light);
					o->Gravity -= AdvanceByDelta(0.1f);
					o->Position[0] -= AdvanceByDelta(o->Gravity * 0.2f);
					o->Position[2] += AdvanceByDelta(o->Gravity);
					o->Scale -= AdvanceByDelta(0.01f);
					break;
				case 16:
				...
				case 5:
					...
					Vector(Luminosity, Luminosity, Luminosity, o->Light);
					o->Gravity -= AdvanceByDelta(0.1f);
					o->Position[0] -= AdvanceByDelta(o->Gravity * ((0.2f) * (rand() % 2 + 1)));
					o->Position[2] += AdvanceByDelta(o->Gravity);
					o->Scale -= AdvanceByDelta(0.01f);
					break;
				case 6:
				...
				case 7:
					Luminosity = 1.0f;
					o->Scale += AdvanceByDelta(0.03f);
					o->Gravity += AdvanceByDelta(1.0f);
					o->Velocity[1] -= AdvanceByDelta(0.1f);
					o->Position[2] -= AdvanceByDelta(o->Gravity);
					if (o->LifeTime < 5)
					{
						Luminosity = (float)(o->LifeTime) / 8.f;
				...
				case 22:
					...
					o->Gravity -= AdvanceByDelta(0.1f);
					o->Position[0] += AdvanceByDelta(o->Gravity * sinf(WorldTime) * 0.05f);
					o->Position[2] += AdvanceByDelta(o->Gravity);
					o->Scale += AdvanceByDelta(0.04f);
					break;
				case 24:
				...
				case 28:
					o->Position[2] += AdvanceByDelta(o->Gravity);
					if (o->LifeTime >= 9)
						o->Scale -= AdvanceByDelta(0.4f);
					else
						o->Scale *= ReduceWithDelta(1.2f);
					Vector(o->Light[0] * 0.92f, o->Light[1] * 0.92f, o->Light[2] * 0.92f, o->Light);
					break;
				case 29:
					o->Position[2] += AdvanceByDelta(o->Gravity);
				...
				case 44:
				{
					if (o->LifeTime >= 30)
					{
						o->Light[0] *= (ReduceWithDelta(1.07f));
						o->Light[1] *= (ReduceWithDelta(1.07f));
						o->Light[2] *= (ReduceWithDelta(1.07f));
					}
					else
					{
						o->Light[0] /= (ReduceWithDelta(1.07f));
					...
					o->Scale += (AdvanceByDelta(0.02f));
					o->Position[2] += (AdvanceByDelta(0.8f));
					o->Rotation += AdvanceByDelta(o->Gravity / (50.0f));
				}
				break;
				case 45:
				{
				...
				case 46:
				{
					...
					o->Gravity -= AdvanceByDelta(0.05f);
					o->Position[2] += AdvanceByDelta((o->Scale + o->Gravity) * (1.5f));
					o->Scale += AdvanceByDelta(o->Scale / (100.0f));
				}
				break;
				case 47:
				{
				...
				case 49:
				{
					if (o->LifeTime < 100)
					{
						o->Light[0] *= (ReduceWithDelta(0.97f));
						o->Light[1] *= (ReduceWithDelta(0.97f));
						o->Light[2] *= (ReduceWithDelta(0.97f));
					}
					else
					{
						o->Light[0] *= (ReduceWithDelta(1.03f));
					...
					VectorScale(o->Velocity, ReduceWithDelta(0.001f), o->Velocity);
					o->Scale += AdvanceByDelta((rand() % 15 + 4) * (0.001f));
					o->Position[2] += AdvanceByDelta(o->Scale * (6.0f));
					o->Rotation += AdvanceByDelta((rand() % 10 + 10) * (0.1f) * o->Angle[0]);
				}
				break;
				case 50:
					if (o->LifeTime < 10)
					...
					{
						o->Alpha += ((rand() % 3 + 2) * ReduceWithDelta(0.1f));
					}
					else
					{
						o->Alpha = 0.5f;
				...
				case 52:
				{
					o->Position[0] += AdvanceByDelta(o->Velocity[0]);
					o->Position[1] += AdvanceByDelta(o->Velocity[1]);
					o->Position[2] += AdvanceByDelta(o->Velocity[2]);
				...
				case 55:
				{
					...
					o->Light[0] /= (ReduceWithDelta(1.08f));
					o->Light[1] /= (ReduceWithDelta(1.08f));
					o->Light[2] /= (ReduceWithDelta(1.08f));
				}
				break;
				case 56:
					Luminosity = (float)(o->LifeTime) / 50.f;
				...
				case 63:
				{
					...
					o->Light[2] /= (ReduceWithDelta(1.1f));
					o->Scale += (AdvanceByDelta(0.5f));
					o->Velocity[1] += (AdvanceByDelta(1.5f));
				}
				break;
				case 64:
				{
					...
					o->Rotation += (AdvanceByDelta(0.05f));//(rand()%100)/100.f;

					o->Gravity -= (AdvanceByDelta(0.1f));
					o->Position[0] += AdvanceByDelta(o->Gravity * sinf(WorldTime) * (0.05f));
					o->Position[2] += AdvanceByDelta(o->Gravity);

					o->Scale += AdvanceByDelta((float)(rand() % 15 + 15) * (0.01f));
				...
				case 66:
				{
					...
					o->Gravity -= (AdvanceByDelta(0.05f));
					o->Position[0] += AdvanceByDelta(o->TurningForce[0] * (o->Scale + o->Gravity) * (1.0f));
					o->Position[1] += AdvanceByDelta(o->TurningForce[1] * (o->Scale + o->Gravity) * (1.0f));
					o->Scale += AdvanceByDelta(o->Scale / (100.0f));
				}
				break;
				case 67:
				{
					o->Alpha -= (AdvanceByDelta(0.01f));

					if (o->Alpha < 0.1f)
					{
						o->Live = false;
					}
					o->Light[0] *= ReduceWithDelta(o->Alpha);
					o->Light[1] *= ReduceWithDelta(o->Alpha);
					o->Light[2] *= ReduceWithDelta(o->Alpha);
				...
				case 68:
				{
					Luminosity = (float)(o->LifeTime) / 40.f;
					Vector(Luminosity * 0.4f, Luminosity * 0.4f, Luminosity * 0.4f, o->Light);
					o->Velocity[0] += AdvanceByDelta((0.03f * o->Velocity[0]));
					o->Velocity[1] += AdvanceByDelta((0.03f * o->Velocity[1]));
					o->Velocity[2] += AdvanceByDelta((0.03f * o->Velocity[2]));

					MovePosition(o->Position, o->Angle, o->Velocity);

					if (o->LifeTime <= 30)
					{
						o->Alpha -= (AdvanceByDelta(0.02f));
					}
				}
				break;
				case 69:
					...
					o->Gravity -= (AdvanceByDelta(0.04f));
					o->Position[0] += AdvanceByDelta(o->Gravity * sinf(WorldTime) * (0.05f));
					o->Position[2] += AdvanceByDelta(o->Gravity);
					o->Scale += (AdvanceByDelta(0.04f));
					break;
			...
			case BITMAP_SMOKE + 3:
				...
				case 0:
					if (o->TurningForce[0] > 0.1f)
						o->TurningForce[0] -= (AdvanceByDelta(0.015f));
					if (o->TurningForce[1] > 0.1f)
						o->TurningForce[0] -= (AdvanceByDelta(0.005f));
					...
					o->Position[2] += (o->Gravity);
					o->Scale += (AdvanceByDelta(0.03f));
					o->Rotation += (AdvanceByDelta(o->Angle[0]));
					break;
				case 1:
					Luminosity = (float)(o->LifeTime) / 55.f;
					Vector(o->TurningForce[0] * Luminosity, o->TurningForce[1] * Luminosity, o->TurningForce[2] * Luminosity, o->Light);
				...
				case 2:
					if (o->TurningForce[1] > 0.1f)
						o->TurningForce[1] -= (AdvanceByDelta(0.005f));
					if (o->TurningForce[2] > 0.1f)
						o->TurningForce[2] -= (AdvanceByDelta(0.015f));
				...
				case 3:
					if (o->Light[0] <= 0.05f)
						o->Live = false;
					o->Light[0] /= (ReduceWithDelta(1.012f));
					o->Light[1] /= (ReduceWithDelta(1.012f));
					o->Light[2] /= (ReduceWithDelta(1.012f));
					o->Scale += (AdvanceByDelta(0.01f));
					o->Rotation += (o->Gravity / ReduceWithDelta(2.0f));
			...
			case BITMAP_SMOKELINE3:
				if (o->SubType == 0 || o->SubType == 5)
				{
					...
					{
						o->Alpha += ((rand() % 5 + 2) * ReduceWithDelta(0.1f));
					}
					else
					{
						o->Alpha = 0.7f;
					...
					Luminosity = o->Alpha;
					Vector(o->TurningForce[0] * Luminosity, o->TurningForce[1] * Luminosity, o->TurningForce[2] * Luminosity, o->Light);
					o->Scale += AdvanceByDelta((rand() % 3 + 6) * (0.01f));//0.07f;
					o->Position[2] += (AdvanceByDelta(o->Gravity));
				...
				else if (o->SubType == 1)
				{
					...
					if (o->Scale > 0)
					{
						o->Scale -= AdvanceByDelta((rand() % 10 + 10) * (0.001f));//0.07f;
					}
					else
					{
						o->Live = false;
				...
				else if ((o->SubType == 2) || (o->SubType == 3))
				{
					...
					Luminosity = o->Alpha;
					Vector(o->TurningForce[0] * Luminosity, o->TurningForce[1] * Luminosity, o->TurningForce[2] * Luminosity, o->Light);
					o->Scale += AdvanceByDelta((rand() % 3 + 6) * (0.01f));
					o->Position[2] += (AdvanceByDelta(o->Gravity));
				}
				else if (o->SubType == 4)
				{
					o->Position[2] += (AdvanceByDelta(o->Gravity));
					o->Rotation += (AdvanceByDelta(0.8f));
					o->Scale += (AdvanceByDelta(0.01f));
			...
			case BITMAP_FIRE_HIK1_MONO:
				if (o->SubType == 0 || o->SubType == 6)
				{
					...
					if (o->Scale > 0)
					{
						o->Scale -= (rand() % 3 + 5) * 0.01f * AdvanceByDelta(1.0);
					}
					else
					{
						o->Live = false;
				...
				else if (o->SubType == 1)
				{
					...
					if (o->Scale > 0)
					{
						o->Scale -= (rand() % 2 + 4) * 0.01f * AdvanceByDelta(1.0);
					}
					else
					{
						o->Live = false;
				...
				else if (o->SubType == 2)
				{
					...
					if (o->Scale > 0)
					{
						o->Scale -= (rand() % 3 + 7) * 0.01f * AdvanceByDelta(1.0);
					}
					else
					{
						o->Live = false;
				...
				else if (o->SubType == 3)
				{
					...
					if (o->Scale > 0)
					{
						o->Scale -= ((rand() % 3 + 2) * 0.01f) * AdvanceByDelta(1.0);
					}
					else
					{
						o->Live = false;
			...
			case BITMAP_FIRE_HIK3_MONO:
				...
				else if (o->SubType == 1)
				{
					...
					if (o->Scale > 0)
					{
						o->Scale -= (rand() % 2 + 6) * 0.01f * AdvanceByDelta(1.0);
					}
					else
					{
						o->Live = false;
				...
				else if (o->SubType == 4)
				{
					...
					if (o->Scale > 0)
					{
						o->Scale -= (rand() % 4 + 5) * 0.01f * AdvanceByDelta(1.0);
					}
					else
					{
						o->Live = false;
				...
				else if (o->SubType == 5)
				{
					...
					if (o->LifeTime < 3)
					{
						o->Scale += AdvanceByDelta((10 - o->LifeTime._runvalue) * 0.02f);
					}
			...
			case BITMAP_LIGHT + 1:
				if (o->SubType == 2)
				{
					o->Scale *= ReduceWithDelta(0.92f);
				}
				else if (o->SubType == 3)
				{
					o->Scale *= ReduceWithDelta(1.3f);
					o->Light[0] *= ReduceWithDelta(0.9f);
					o->Light[1] *= ReduceWithDelta(0.9f);
					o->Light[2] *= ReduceWithDelta(0.9f);
				}
				...
				{
					o->LifeTime = 5;
					o->Light[0] *= ReduceWithDelta(0.7f);
					o->Light[1] *= ReduceWithDelta(0.7f);
					o->Light[2] *= ReduceWithDelta(0.7f);
				}
				else if (o->SubType == 4)
				{
				...
				{
					o->Position[2] -= AdvanceByDelta(o->Gravity);
					o->Position[1] -= AdvanceByDelta(1.f);
					o->Gravity += AdvanceByDelta(1.f);
					o->Scale *= ReduceWithDelta(0.95f);
				}
				break;
			case BITMAP_BLOOD:
			case BITMAP_BLOOD + 1:
				o->Frame = (12 - o->LifeTime._runvalue) / 3;
				VectorScale(o->Velocity, ReduceWithDelta(0.95f), o->Velocity);
			...
			case BITMAP_SPARK:
				...
				if (o->SubType == 7)
					o->Gravity -= AdvanceByDelta(0.6f);
				else if (o->SubType == 9)
					o->Gravity -= AdvanceByDelta(0.4f);
				else
					o->Gravity -= AdvanceByDelta(2.f);

				Height = RequestTerrainHeight(o->Position[0], o->Position[1]);
				if (o->Position[2] < Height)
				{
					o->Position[2] = Height;
					o->Gravity = -o->Gravity * ReduceWithDelta(0.6f);
					o->LifeTime -= AdvanceByDelta(4);
				}
				interpolatesum2(o->Position, o->Velocity, o->Position);
			...
			case BITMAP_SPARK + 1:
				...
				case 9:
				{
					o->Velocity[0] -= AdvanceByDelta(1.2f);
					o->Velocity[2] -= AdvanceByDelta(1.0f);
					o->Scale -= AdvanceByDelta(0.08f);
					if (o->LifeTime <= 0)
						o->Live = false;
					if (o->Scale < 0.2f)
				...
				case 11:
				{
					o->Light[0] /= ReduceWithDelta(1.05f);
					o->Light[1] /= ReduceWithDelta(1.05f);
					o->Light[2] /= ReduceWithDelta(1.05f);
					o->Scale -= AdvanceByDelta(0.04f);
					o->Alpha -= AdvanceByDelta(0.001f);
					if (o->Alpha <= 0.0f)
						o->Live = false;
				...
				case 18:
				{
					...
					if (o->Frame == 77)
					{
						o->Gravity *= ReduceWithDelta(1.03f);
						o->Position[2] -= AdvanceByDelta(o->Gravity);
					}
					else if (o->Frame == 88)
					{
						o->Gravity /= ReduceWithDelta(1.2f);
						if (o->Gravity <= 0.1f)
						{
							o->Gravity = 0.1f;
							o->Frame = 99;
				...
				case 20:
				{
					...
					o->Position[2] += AdvanceByDelta(o->Gravity * (0.5f));
					o->Gravity -= AdvanceByDelta(1.5f);
				...
				case 23:
				{
					...
					o->Light[2] /= ReduceWithDelta(1.05f);
					o->Scale -= AdvanceByDelta(0.02f);
					o->Alpha -= AdvanceByDelta(0.0001f);
					if (o->Alpha <= 0.0f)
						o->Live = false;
				}
				break;
				case 24:
				{
					if (o->LifeTime < 10 && o->Rotation == 0)
					{
						VectorScale(o->Velocity, ReduceWithDelta(-1), o->Velocity);
						o->Rotation = 1;
					}
				...
				case 25:
				{
					if (o->LifeTime == 19)
					{
						o->Velocity[0] -= AdvanceByDelta(1.f);
						o->Velocity[1] -= AdvanceByDelta(1.f);
						o->Velocity[2] -= AdvanceByDelta(1.f);
					}
				...
				case 30:
				{
					if (o->LifeTime <= 45)
					{
						o->Velocity[0] += AdvanceByDelta(sinf(Q_PI / 180.0f * float(rand() % 360)));
						o->Velocity[1] += AdvanceByDelta(cosf(Q_PI / 180.0f * float(rand() % 360)));
					}
			...
			case BITMAP_SMOKE + 4:
				...
				//o->Angle[0] += (4.f);
				interpolatesum2(o->Position, o->Velocity, o->Position);
				VectorScale(o->Velocity, ReduceWithDelta(0.9f), o->Velocity);

				if (o->SubType == 6)
				{
					o->Scale -= AdvanceByDelta(0.05f);
					o->Position[2] += AdvanceByDelta(4.0f);
				}
				else if (o->SubType != 5)
				{
			...
			case BITMAP_SHINY:
				if (o->SubType == 2)
				{
					o->Rotation -= AdvanceByDelta(12.f);

					o->Velocity[2] -= AdvanceByDelta((float)(rand() % 8) * 0.05f);
					VectorAdd(o->Position, o->Velocity, o->Position);
				...
				{
					o->Rotation += AdvanceByDelta(20.f);
					o->Position[2] += AdvanceByDelta(o->Gravity * (0.5f));
				...
				{
					o->Rotation += AdvanceByDelta(10.f);
					o->Position[2] += AdvanceByDelta(o->Gravity);
				...
				else if (o->SubType == 6 || o->SubType == 8 || o->SubType == 9)
				{
					...
					o->StartPosition[0] /= ReduceWithDelta(1.01f);
					...
					if (o->LifeTime < 60)
					{
						o->Velocity[0] /= ReduceWithDelta(1.04f);
						o->Velocity[1] /= ReduceWithDelta(1.04f);
						o->Velocity[2] /= ReduceWithDelta(1.04f);
			...
			case BITMAP_SHINY + 1:
				...
				{
					VectorCopy(o->Target->Position, o->Position);
					o->Position[2] += AdvanceByDelta(50.f);
					o->Rotation -= AdvanceByDelta(1.f);
				}
				else
				{
					if (o->SubType == 5)
			...
			case BITMAP_SHINY + 4:
				...
				else if (o->SubType == 1)
				{
					...
					if (o->LifeTime < 6)
					{
						o->Light[0] *= ReduceWithDelta(0.5f);
						o->Light[1] *= ReduceWithDelta(0.5f);
						o->Light[2] *= ReduceWithDelta(0.5f);
					}
				}
				else if (o->SubType == 2)
				{
					o->Scale *= ReduceWithDelta(1.1f);
					VectorScale(o->Light, ReduceWithDelta(0.9f), o->Light);
				}
				break;
			case BITMAP_SHINY + 6:
				if (o->SubType == 0)
				{
					o->Rotation += AdvanceByDelta(5.f);
					o->Scale -= AdvanceByDelta(0.02f);
					o->Alpha -= AdvanceByDelta(0.001f);
					if (o->Alpha <= 0.0f)
						o->Live = false;
					...
					o->Light[0] += AdvanceByDelta(fLight);
					o->Light[1] += AdvanceByDelta(fLight);
					o->Light[2] += AdvanceByDelta(fLight);
				}
				else if (o->SubType == 1)
				{
					o->Scale -= AdvanceByDelta(0.01f);
			...
			case BITMAP_ORORA:
			{
				...
				if (pModel)
				{
					...
					VectorCopy(vPos, o->Position);
					o->Scale += AdvanceByDelta(fScale);
					if (o->Scale >= 0.8f)
					{
						o->Light[0] /= ReduceWithDelta(fLight);
						o->Light[1] /= ReduceWithDelta(fLight);
						o->Light[2] /= ReduceWithDelta(fLight);
					}
				}
			}
			break;
			...
			case BITMAP_DS_EFFECT:
				...
				break;
			case BITMAP_FIRECRACKER:
				o->Velocity[2] -= AdvanceByDelta(.5f);
				break;
			case BITMAP_SWORD_FORCE:
				o->Gravity += AdvanceByDelta(0.01f);
				o->Scale += (o->Gravity);
			...
			case BITMAP_GHOST_CLOUD2:
			{
				if (o->SubType == 0)
				{
					...
					if (fSin > 0.f)
						o->Rotation += AdvanceByDelta(0.2f + (rand() % 4 * 0.1f));
					else
						o->Rotation -= AdvanceByDelta(0.2f + (rand() % 4 * 0.1f));
			...
			case BITMAP_CLOUD:
				if (o->SubType == 6)
				{
					...
					o->Velocity[0] *= ReduceWithDelta(0.95f);
					o->Velocity[1] *= ReduceWithDelta(0.95f);
					o->Velocity[2] += AdvanceByDelta(0.6f);
					o->Position[0] += AdvanceByDelta((float)(rand() % 4 - 2));
					o->Position[1] += AdvanceByDelta((float)(rand() % 4 - 2));
					o->Position[2] += AdvanceByDelta((float)(rand() % 4 - 2) * 0.8f);
					o->Scale += AdvanceByDelta(0.05f);
					o->Light[0] = (float)(o->LifeTime) / 50.f;
					o->Light[1] = o->Light[0];
					o->Light[2] = o->Light[0];
					o->Rotation += AdvanceByDelta((1.f + rand() % 2));
				}
				else if (o->SubType == 8)
				{
					if (o->LifeTime <= 0)
					...
					{
						if (o->Alpha < 1.0f)
							o->Alpha += AdvanceByDelta(0.04);
						o->Position[2] += AdvanceByDelta(1.f);
					}
					else
					{
						if (o->Alpha > 0.1f)
							o->Alpha -= AdvanceByDelta(0.025f);
						o->Position[2] -= AdvanceByDelta(0.5f);
					}
				}
				else if (o->SubType == 9)
				{
				...
				else if (o->SubType == 11)
				{
					...
					o->Rotation += AdvanceByDelta((0.5f + rand() % 2));
				...
				{
					o->Rotation += AdvanceByDelta(o->Gravity * 1.5f);
				}
				else if (o->SubType == 14)
				{
					interpolatesum(o->Position, o->Velocity);
				...
				else if (o->SubType == 17)
				{
					...
					o->Rotation += AdvanceByDelta((0.08f + rand() % 2 * 0.15f));
				...
				else if (o->SubType == 18)
				{
					...
					if (o->LifeTime > 90)
					{
						o->Light[0] += AdvanceByDelta(0.0020f);
						o->Light[1] += AdvanceByDelta(0.0020f);
						o->Light[2] += AdvanceByDelta(0.0017f);
					}
					else if (o->LifeTime < 30)
					{
						o->Light[0] -= AdvanceByDelta(0.0040f);
						o->Light[1] -= AdvanceByDelta(0.0040f);
						o->Light[2] -= AdvanceByDelta(0.0033f);
					}
					if (o->Scale > 0)
						o->Scale -= AdvanceByDelta(0.001f);
					if (o->TurningForce[1] > 0)
						o->TurningForce[1] -= AdvanceByDelta(0.5f);
					...
					o->Position[2] += AdvanceByDelta(((rand() % 10) / 10.0f));
				...
				else if (o->SubType == 19)
				{
					...
					o->Position[1] += AdvanceByDelta((8.0f + (rand() % 200) * 0.1f));
				...
				else if (o->SubType == 21)
				{
					if (o->LifeTime <= 0) {
						...
						if (o->Alpha < 1.0f)
							o->Alpha += AdvanceByDelta(0.04);
						o->Position[2] += AdvanceByDelta(2.f);
					}
					else {
						if (o->Alpha > 0.1f)
							o->Alpha -= AdvanceByDelta(0.005f);
						o->Position[2] -= AdvanceByDelta(1.0f);
					}
				}
				else if (o->SubType == 22)
				{
				...
				else if (o->SubType == 23)
				{
					...
					else if (o->LifeTime > 40)
					{
						...
						o->Scale += AdvanceByDelta(0.003f);
					}
					else
					{
						o->Velocity[0] *= ReduceWithDelta(0.7f);
						o->Velocity[1] *= ReduceWithDelta(0.7f);

						if (o->Alpha > 0.0f)
							o->Alpha -= AdvanceByDelta((rand() % 10 * 0.01f));
						else
							o->Live = false;
						o->Position[2] += AdvanceByDelta(0.2f);

						//o->Scale += (0.0005f);
					}
					o->Rotation += (o->TurningForce[0] * ReduceWithDelta(5.0f));
				}
				else
				{
					Luminosity = 0.6f;
			...
			case BITMAP_LIGHT:
				if (0 == o->SubType || 2 == o->SubType || o->SubType == 7 || o->SubType == 8)
				{
					...
					if (o->SubType == 7)
					{
						...
						o->Position[2] += AdvanceByDelta(fScale);
					}
					else
					{
						...
						o->Position[2] += AdvanceByDelta((5.f * fScale));
					}
					...
					{
						o->Rotation += AdvanceByDelta(30.f);
					}
					else if (1 == o->SubType)
					{
						o->Scale *= ReduceWithDelta(0.98f);
					}
					else if (5 == o->SubType)
					{
						o->Scale *= ReduceWithDelta(0.95f);
				...
				else if (o->SubType == 6)
				{
					...
					o->Position[2] += AdvanceByDelta((5.f * fScale));
					o->Scale *= ReduceWithDelta(0.95f);
					o->Light[0] *= ReduceWithDelta(0.95f);
					o->Light[1] *= ReduceWithDelta(0.95f);
					o->Light[2] *= ReduceWithDelta(0.95f);
					if (o->Scale <= 0.1f)
					{
						o->LifeTime = -1;
						o->Live = 0;
				...
				{
					VectorScale(o->Light, ReduceWithDelta(0.9f), o->Light);
					o->Scale *= ReduceWithDelta(0.85f);
					o->Gravity += AdvanceByDelta(5.f);

					VectorCopy(o->Target->Position, o->Position);

					o->Position[0] += AdvanceByDelta(2.f);
					o->Position[1] -= AdvanceByDelta(2.f);
					o->Position[2] += AdvanceByDelta(o->Gravity);
				}
				else if (o->SubType == 4)
				{
					...
					o->Gravity += AdvanceByDelta(((rand() % 40 + 60) / 100.f * 9.5f));
					o->Scale -= AdvanceByDelta(((rand() % 400 + 400) / 10000.f));
					o->Position[2] += (o->Gravity);

					o->Light[0] /= ReduceWithDelta(1.35);
					o->Light[1] /= ReduceWithDelta(1.35);
					o->Light[2] /= ReduceWithDelta(1.35);
				}
				else if (o->SubType == 9)
				{
					o->Scale -= AdvanceByDelta(0.011f);
					if (!o->Live)
						o->LifeTime = 0;
					if (o->Scale <= 0.0f)
						o->LifeTime = 0;
				...
				{
					o->Position[2] += AdvanceByDelta(o->Gravity);
					o->Scale -= AdvanceByDelta(0.0005f);
				}
				else if (o->SubType == 12)
				{
					if (o->LifeTime > 80)
				...
				{
					VectorScale(o->Light, ReduceWithDelta(0.98f), o->Light);
					o->Scale *= ReduceWithDelta(0.95f);
				}
				else if (o->SubType == 15)
				{
					o->StartPosition[2] += AdvanceByDelta(((rand() % 10 + 5) * 0.01f));
			...
			case BITMAP_POUNDING_BALL:
				...
				else if (o->SubType == 3)
				{
					...
					{
						o->Alpha += ((rand() % 2 + 2) * ReduceWithDelta(0.1f));
					}
					else
					{
						o->Alpha = 1.0f;
					...
					if (o->Scale > 0)
					{
						o->Scale -= AdvanceByDelta(((rand() % 3 + 5) * 0.01f));
					}
					else
					{
						o->Live = false;
			...
			case BITMAP_ADV_SMOKE + 1:
				...
				o->Velocity[1] *= ReduceWithDelta(0.95f);
				o->Velocity[2] += AdvanceByDelta(0.6f);
				o->Position[0] += AdvanceByDelta((float)(rand() % 4 - 2.0));
				o->Position[1] += AdvanceByDelta((float)(rand() % 4 - 2.0));
				o->Position[2] += AdvanceByDelta((float)(rand() % 4 - 2.0) * 0.8);
				o->Scale += AdvanceByDelta(0.05f);
				if (o->SubType == 2)
				{
			...
			case BITMAP_TRUE_BLUE:
				...
				if (o->SubType >= 3 && o->SubType < 5 && o->Target != NULL)
				{
					...
					if (BoneManager::GetBonePosition(o->Target, name, TargetPosition)) {
						...
						o->Scale -= AdvanceByDelta(length * (0.003f));
						o->Light[0] -= AdvanceByDelta(length * (0.08f));
						o->Light[1] -= AdvanceByDelta(length * (0.08f));
						o->Light[2] -= AdvanceByDelta(length * (0.08f));
					}
				}
				...
				{
					o->Scale -= AdvanceByDelta(0.1f);
					o->Position[2] += AdvanceByDelta(2.0f);
				}
				else
					o->Scale -= AdvanceByDelta(0.02f);
			...
			case BITMAP_HOLE:
				...
				if (o->LifeTime < 20)
				{
					...
					if (o->LifeTime < 10)
					{
						o->Light[0] /= ReduceWithDelta(1.3f);
						o->Light[1] /= ReduceWithDelta(1.3f);
						o->Light[2] /= ReduceWithDelta(1.3f);
					}
				}
				else if (o->LifeTime < 30)
				{
			...
			case BITMAP_WATERFALL_1:
				...
				o->Velocity[2] += AdvanceByDelta(0.1f);
			...
			case BITMAP_WATERFALL_5:
				...
				{
					o->Scale += (AdvanceByDelta(0.1f));
					o->Position[0] += (AdvanceByDelta(rand() % 10 - 5.f));
					o->Position[1] += (AdvanceByDelta(rand() % 10 - 5.f));
				}
				else if (o->SubType == 2)
				{
					if (o->Scale < 1.0f)
				...
				{
					o->Scale -= (AdvanceByDelta(0.005f));
					o->Rotation += (AdvanceByDelta(4.f));
					o->Velocity[2] += (AdvanceByDelta(0.1f));
				}
				else if (o->SubType == 4)
				{
					o->Position[0] += AdvanceByDelta((float)(cos(o->Angle[2]) * 20.0f));
					o->Position[1] += AdvanceByDelta((float)(sin(o->Angle[2]) * 20.0f));
					o->Position[2] += (AdvanceByDelta(o->Gravity));
					o->Rotation += (AdvanceByDelta(1));
				}
				else if (o->SubType == 5)
			...
			case BITMAP_PLUS:
				o->Scale -= (AdvanceByDelta(0.01f));
				o->Position[0] += (AdvanceByDelta(rand() % 2 - 1));
				o->Position[1] += (AdvanceByDelta(rand() % 2 - 1));
				o->Position[2] += (AdvanceByDelta(2.f));
			...
			case BITMAP_WATERFALL_2:
				if (o->SubType == 5)
				{
					...
					o->Position[0] += AdvanceByDelta(o->Velocity[0]);
					o->Position[1] += AdvanceByDelta(o->Velocity[1]);
					o->Position[2] += AdvanceByDelta(o->Gravity + o->Velocity[2]);
				...
				o->Scale += (AdvanceByDelta(0.03f));
				o->Velocity[0] = AdvanceByDelta((rand() % 20 - 10) * 0.1);
				o->Velocity[1] = AdvanceByDelta((rand() % 20 - 10) * 0.1);
				o->Velocity[2] += (AdvanceByDelta(0.1f));
				if (o->LifeTime < 10)
				{
					o->Light[0] /= (ReduceWithDelta(1.1f));
				...
				if (o->SubType == 3)
				{
					o->Scale -= (AdvanceByDelta(0.038f));
					o->Velocity[2] -= (AdvanceByDelta(0.02f));
					o->Light[0] /= (ReduceWithDelta(1.02f));
					o->Light[1] /= (ReduceWithDelta(1.02f));
					o->Light[2] /= (ReduceWithDelta(1.02f));
				}
				if (o->SubType == 4)
				{
					o->Rotation -= (AdvanceByDelta(1.1f));
				}
				if (o->SubType == 6)
				{
					o->Gravity += (AdvanceByDelta(rand() % 5 + 1.5f * (o->LifeTime._runvalue / 5.0f)));

					o->Velocity[0] += (AdvanceByDelta(1));

					o->Velocity[0] -= (AdvanceByDelta(100 * (20.0f / o->LifeTime._runvalue)));
					o->Rotation += (AdvanceByDelta(50.f));
					AngleMatrix(o->Angle, Matrix);
					VectorRotate(o->Velocity, Matrix, TargetPosition);
					VectorAdd(o->StartPosition, TargetPosition, o->Position);
					o->Scale += (AdvanceByDelta((1.0 / o->LifeTime._runvalue) * 2.0f));

					o->Light[0] *= (ReduceWithDelta(0.80f));
					o->Light[1] *= (ReduceWithDelta(0.77f));
					o->Light[2] *= (ReduceWithDelta(0.77f));
			...
			case BITMAP_WATERFALL_4:
				...
				{
					o->Scale += AdvanceByDelta(0.005f);
					o->Velocity[2] -= AdvanceByDelta(0.05f);
					o->Light[0] *= ReduceWithDelta(0.97f);
					o->Light[1] *= ReduceWithDelta(0.97f);
					o->Light[2] *= ReduceWithDelta(0.97f);
					break;
				...
				{
					o->Velocity[2] += (AdvanceByDelta(0.01f));
					o->Light[0] *= (ReduceWithDelta(0.97f));
					o->Light[1] *= (ReduceWithDelta(0.97f));
					o->Light[2] *= (ReduceWithDelta(0.97f));
					break;
				...
				else if (o->SubType == 12)
				{
					...
					o->Scale *= (ReduceWithDelta(0.92f));
					o->Light[0] *= (ReduceWithDelta(0.92f));
					o->Light[1] *= (ReduceWithDelta(0.92f));
					o->Light[2] *= (ReduceWithDelta(0.92f));
					o->Alpha *= (ReduceWithDelta(0.8f));
					break;
				}
				else if (o->SubType == 13)
				{
				...
				o->Scale += (AdvanceByDelta(0.005f));
				o->Velocity[2] -= (AdvanceByDelta(2.5f));
				o->Light[0] /= (ReduceWithDelta(1.1f));
				o->Light[1] /= (ReduceWithDelta(1.1f));
				o->Light[2] /= (ReduceWithDelta(1.1f));
				break;
			...
			case BITMAP_SHOCK_WAVE:
			{
				if (o->SubType == 3)
				{
					o->Light[0] /= (ReduceWithDelta(1.8f));
					o->Light[1] /= (ReduceWithDelta(1.8f));
					o->Light[2] /= (ReduceWithDelta(1.8f));
					o->Scale += (AdvanceByDelta(0.3f));
				}
				else if (o->SubType == 0)
				{
					o->Light[0] /= ReduceWithDelta(1.5f);
					o->Light[1] /= ReduceWithDelta(1.5f);
					o->Light[2] /= ReduceWithDelta(1.5f);
					o->Scale += AdvanceByDelta(0.8f);
				}
				if (o->SubType == 4)
				{
					o->Alpha -= AdvanceByDelta(0.001f);
					...
					o->Light[1] /= ReduceWithDelta(1.03f);
					o->Light[2] /= ReduceWithDelta(1.03f);
					o->Scale += AdvanceByDelta(o->Gravity * 0.015f);
					o->Gravity += AdvanceByDelta(2.4f);
				}
			}
			break;
			case BITMAP_CURSEDTEMPLE_EFFECT_MASKER:
			...
			case BITMAP_RAKLION_CLOUDS:
			{
				...
				o->Scale += AdvanceByDelta(SCALEFACTOR);
				o->Light[0] /= ReduceWithDelta(LIGHTDIVIDEDFACTOR);
				o->Light[1] /= ReduceWithDelta(LIGHTDIVIDEDFACTOR);
				o->Light[2] /= ReduceWithDelta(LIGHTDIVIDEDFACTOR);
			...
			case BITMAP_AG_ADDITION_EFFECT:
			{
				...
				if (b)
				{
					...
					if (o->SubType == 0)
					{
						o->Scale *= ReduceWithDelta(1.05f);
						Temp_Pos[2] -= (10.0f);
					}
					else if (o->SubType == 1)
					{
						o->Scale *= ReduceWithDelta(1.02f);
						Temp_Pos[2] += (10.0f);
					}
					else if (o->SubType == 2)
					{
			...
			{
				o->Scale *= ReduceWithDelta(1.2f);
				VectorScale(o->Light, ReduceWithDelta(0.8f), o->Light);
			}
			break;
			case BITMAP_SWORD_EFFECT_MONO:
			{
				...
				VectorScale(o->Light, ReduceWithDelta(0.94f), o->Light);
			}
			break;
			case BITMAP_DAMAGE2:
			{
				o->Scale *= ReduceWithDelta(1.2f);
				VectorScale(o->Light, ReduceWithDelta(0.55f), o->Light);
			}
			break;
			}
		}
	...
	for (int i = 0; i < MAX_PARTICLES; i++)
	{
		...
		if (o->Live)
		{
			...
			case BITMAP_SWORD_EFFECT_MONO:
			{
				vec3_t vPos;
				VectorCopy(o->Position, vPos);
				vPos[2] += (ReduceWithDelta(31.0f) * o->Scale);
