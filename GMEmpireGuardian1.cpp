...
bool GMEmpireGuardian1::PlayMonsterSound(OBJECT* o)
{
	...
	case MODEL_MONSTER01 + 167:
	{
		...
		case MONSTER01_ATTACK1:
		{
			PlayBuffer(SOUND_EMPIREGUARDIAN_JERINT_MONSTER_ATTACK01);	// ����1 ����
		}
		break;
		case MONSTER01_ATTACK2:
		{
			PlayBuffer(SOUND_EMPIREGUARDIAN_JERINT_MONSTER_ATTACK03);	// ����2 ����
		}
		break;
		case MONSTER01_ATTACK3:
		{
			PlayBuffer(SOUND_EMPIREGUARDIAN_ERCANNE_MONSTER_ATTACK03);	// ����3 ����
		}
		break;
		case MONSTER01_APEAR:
		{
			PlayBuffer(SOUND_EMPIREGUARDIAN_RAYMOND_MONSTER_RAGE);	// ����ȭ ����
		}
		break;
		case MONSTER01_DIE:
		{
